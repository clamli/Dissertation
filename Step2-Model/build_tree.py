...
if (__name__ == '__main__'):
	...
	finput_iuclst_rating_matrix = sys.argv[3]
	finput_user_cluster_set = sys.argv[4]
	finput_desired_depth = int(sys.argv[5])
	...
	# build tree
	dt_model = DecisionTree(iu_sparse_matrix_train, iu_sparse_matrix_test, iuclst_rating_matrix, user_cluster_set, finput_desired_depth)
